...
func DoUpgrade(helper *up.Helper) {
	...
	helper.Copy(up.Bool, "bridge", "presence_bridging")
	helper.Copy(up.Int, "bridge", "presence_refresh_seconds")
	helper.Copy(up.Int|up.Float, "bridge", "presence_max_per_second")
